...
def get_dashboard(
    ...
    return DashboardOut(
        ...
        monthly_revenue_goal=result.monthly_revenue_goal,
        goal_progress_percentage=result.goal_progress_percentage,
        breakeven_beaten=result.breakeven_beaten,
        breakeven_beaten_date=result.breakeven_beaten_date,
